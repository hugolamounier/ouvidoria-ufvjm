...
$(document).ready(function(){
    ...
    grafico(<?php echo json_encode(Graficos::consultaCampus($db_conn, $di, $df), JSON_NUMERIC_CHECK) ?>, ["#CB4335","#2E86C1","#28B463","#F1C40F","#F39C12", "#76D7C4"], 'chartUnidadeEnvolvida', '', '', 'doughnut', 14);
