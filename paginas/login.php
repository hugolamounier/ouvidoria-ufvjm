            ...
            <div class="col s8 offset-s2">
                <div class="login z-depth-2 valign-wrapper">
                    <div class="loginInfo">
                        ...
                        <div class="row">
                            <div class="col s4 offset-s8"><a class="blue darken-4 waves-effect waves-light btn-large hoverable" onClick="login();"><i class="material-icons left">send</i>Entrar</a></div>
                        </div>
                    </div>
                </div>
            </div>
